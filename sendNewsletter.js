...
function structureEmail(data) {
    ...
    for (let i = 0; i < data.news.length; i++) {
        ...
        <a href="${data.news[i].href}" target="_blank">${data.news[i].innerText}</a><p></p><span class="time" style="margin: 0; padding: 0; font-family: Arial, sans-serif; font-size: 14px;">${formatTime(data.news[i].newsTime)}</span> • <span class="tag" style="margin: 0; padding: 0; font-family: Arial, sans-serif; font-size: 14px;">${data.news[i].tag}</span>
        </div>
